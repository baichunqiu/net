...
public class ResourceUtil {
    ...
    public static byte[] readBytesFromRaw(int rawId) {
        ...
        byte[] buffer = null;
        try {
            is = UI.getResources().openRawResource(rawId);
            int size = is.available();
            buffer = new byte[size];
            is.read(buffer);
        } catch (IOException e) {
    ...
    public static String getString(int strId) {
        return UI.getResources().getString(strId);
    }
    ...
    public static int getColor(int colorId) {
        return UI.getResources().getColor(colorId);
    }
    ...
    public static Drawable getDrawable(int drawableId) {
        return UI.getResources().getDrawable(drawableId);
    }
    ...
    public static String[] getStringArray(int resID) {
        return UI.getResources().getStringArray(resID);
    }
    ...
    public static int[] getIntArray(int resID) {
        return UI.getResources().getIntArray(resID);
    }
    ...
    public static float getDimension(int resID) {
        return UI.getResources().getDimension(resID) * getDensity();
    }

    public static float getDimensionDP(int resID) {
        return UI.getResources().getDimension(resID);
    }

    private static float density = -1;
    public static float getDensity() {
        if (density < 0){
            density =  UI.getResources().getDisplayMetrics().density;
        }
        return density;
    }
