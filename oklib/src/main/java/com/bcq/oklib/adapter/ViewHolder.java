...
import com.bcq.oklib.utils.ImageLoader;
...
public class ViewHolder {
    ...
    public ViewHolder setHtmlText(int viewId, Spanned text) {
        TextView tv = getView(viewId);
        tv.setText(text);
        return this;
    }
    ...
    public ViewHolder setImageUrl(int viewId, String imageUrl, int defaultResouce) {
        ...
        ImageLoader.loadItem(intoView,imageUrl);
        return this;
    }
    ...
    public ViewHolder setVisibleInvs(int viewId, boolean visible) {
        View view = getView(viewId);
    ...
    public ViewHolder setFocusable(int viewId, boolean selected) {
        View view = getView(viewId);
